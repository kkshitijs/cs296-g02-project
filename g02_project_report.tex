...
>>>>>>> e0a473aee53897d3a82d8f349767f474307703bd
...
\begin{figure}
\centering
\subfloat[Stage 1]{\includegraphics[width=70mm, height=50mm]{state_01.eps}}
\subfloat[Stage 2]{\includegraphics[width=70mm, height=50mm]{state_02.eps}}\\
\subfloat[Stage 3]{\includegraphics[width=70mm, height=50mm]{state_03.eps}}
\subfloat[Stage 4]{\includegraphics[width=70mm, height=50mm]{state_04.eps}}\\
\subfloat[Stage 5]{\includegraphics[width=70mm, height=50mm]{state_05.eps}}
\subfloat[Stage 6]{\includegraphics[width=70mm, height=50mm]{state_06.eps}}\\
\subfloat[Stage 7]{\includegraphics[width=70mm, height=50mm]{state_07.eps}}
\subfloat[Stage 8]{\includegraphics[width=70mm, height=50mm]{state_08.eps}}\\
